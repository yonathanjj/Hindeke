      ...
      <nav class="navbar">
        <div class="navbar-container">
          <a href="index.html" class="brand">
            <img src="logo.png" alt="Hindeke Logo" class="logo">
          </a>
      ...
      <footer class="footer">
        <div class="footer-container">
          <div class="footer-brand">
            <h2 class="footer-logo">Hindeke</h2>
            <p class="footer-tagline">Dress it, Put a crown on it! 2015.</p>
        ...
        <div class="footer-bottom">
          <p>© ${new Date().getFullYear()} Hindeke. All rights reserved.</p>
